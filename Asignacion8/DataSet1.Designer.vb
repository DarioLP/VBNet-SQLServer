...
Partial Public Class DataSet1
    ...
    Partial Public Class RegistroDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddRegistroRow(ByVal Correo As String, ByVal Usuario As String, ByVal Nombre As String, ByVal Contraseña As String, ByVal Telefono As String) As RegistroRow
            Dim rowRegistroRow As RegistroRow = CType(Me.NewRow,RegistroRow)
            Dim columnValuesArray() As Object = New Object() {Correo, Usuario, Nombre, Contraseña, Telefono}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function FindByCorreo(ByVal Correo As String) As RegistroRow
            Return CType(Me.Rows.Find(New Object() {Correo}),RegistroRow)
        End Function
    ...
    Partial Public Class RegistroRow
        ...
        Public Property Correo() As String
            Get
                Return CType(Me(Me.tableRegistro.CorreoColumn),String)
            End Get
            Set
                Me(Me.tableRegistro.CorreoColumn) = value
            End Set
        End Property
        ...
        Public Function IsContraseñaNull() As Boolean
            Return Me.IsNull(Me.tableRegistro.ContraseñaColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetContraseñaNull()
            Me(Me.tableRegistro.ContraseñaColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function IsTelefonoNull() As Boolean
            Return Me.IsNull(Me.tableRegistro.TelefonoColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetTelefonoNull()
            Me(Me.tableRegistro.TelefonoColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class RegistroTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Registro] WHERE (([Correo] = @Original_Correo) AND ((@IsNull_U"& _ 
                ...
                "aseña)) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Ori"& _ 
                "ginal_Telefono)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Registro] ([Correo], [Usuario], [Nombre], [Contraseña], [Telef"& _ 
                "ono]) VALUES (@Correo, @Usuario, @Nombre, @Contraseña, @Telefono);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Corre"& _ 
                "o, Usuario, Nombre, Contraseña, Telefono FROM Registro WHERE (Correo = @Correo)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Registro] SET [Correo] = @Correo, [Usuario] = @Usuario, [Nombre] = "& _ 
                "@Nombre, [Contraseña] = @Contraseña, [Telefono] = @Telefono WHERE (([Correo] = @"& _ 
                "Original_Correo) AND ((@IsNull_Usuario = 1 AND [Usuario] IS NULL) OR ([Usuario] "& _ 
                "= @Original_Usuario)) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre"& _ 
                "] = @Original_Nombre)) AND ((@IsNull_Contraseña = 1 AND [Contraseña] IS NULL) OR"& _ 
                " ([Contraseña] = @Original_Contraseña)) AND ((@IsNull_Telefono = 1 AND [Telefono"& _ 
                "] IS NULL) OR ([Telefono] = @Original_Telefono)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Correo, Usuario, Nomb"& _ 
                "re, Contraseña, Telefono FROM Registro WHERE (Correo = @Correo)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Asignacion8.My.MySettings.Default.ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Correo, Usuario, Nombre, Contraseña, Telefono FROM dbo.Registro"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet1.RegistroDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSet1.RegistroDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet1.RegistroDataTable = New DataSet1.RegistroDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DataSet1.RegistroDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Correo As String, ByVal Original_Usuario As String, ByVal Original_Nombre As String, ByVal Original_Contraseña As String, ByVal Original_Telefono As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Correo As String, ByVal Usuario As String, ByVal Nombre As String, ByVal Contraseña As String, ByVal Telefono As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Correo As String, ByVal Usuario As String, ByVal Nombre As String, ByVal Contraseña As String, ByVal Telefono As String, ByVal Original_Correo As String, ByVal Original_Usuario As String, ByVal Original_Nombre As String, ByVal Original_Contraseña As String, ByVal Original_Telefono As String) As Integer
            If (Correo Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Correo")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Usuario As String, ByVal Nombre As String, ByVal Contraseña As String, ByVal Telefono As String, ByVal Original_Correo As String, ByVal Original_Usuario As String, ByVal Original_Nombre As String, ByVal Original_Contraseña As String, ByVal Original_Telefono As String) As Integer
            Return Me.Update(Original_Correo, Usuario, Nombre, Contraseña, Telefono, Original_Correo, Original_Usuario, Original_Nombre, Original_Contraseña, Original_Telefono)
        End Function
    End Class
